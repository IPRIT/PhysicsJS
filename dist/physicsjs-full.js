    ...
    return {
      ...
      integrateVelocities: function( bodies, dt ){
        ...
        for ( var i = 0, l = bodies.length; i < l; ++i ){
          ...
          if ( body.treatment !== 'static' && !body.sleep( dt ) && !(body.bodyName && body.bodyName === 'feed') ){
      ...
      integratePositions: function( bodies, dt ){
        ...
        for ( var i = 0, l = bodies.length; i < l; ++i ){
          ...
          // only integrate if the body isn't static
          if ( body.treatment !== 'static' && !body.sleep() && !(body.bodyName && body.bodyName === 'feed') ){
    ...
    return {
      ...
      behave: function( data ){
        ...
        for ( var j = 0, l = bodies.length; j < l; j++ ){
          ...
          if (body.bodyName && body.bodyName === 'feed') {
            continue;
          }
    ...
    return {
      ...
      check: function( data ){
        ...
        var candidates = data.candidates
          ...
          ,ignoreBetween = this.options.ignoreBetween || []
          ,collisions = []
          ,ret
        ...
        for ( var i = 0, l = candidates.length; i < l; ++i ){
          ...
          if (
            !(
              pair.bodyA.bodyName &&
              ignoreBetween.includes( pair.bodyA.bodyName ) &&
              pair.bodyA.bodyName === pair.bodyB.bodyName
            ) && (
      ...
      checkAll: function( data ){
        ...
        for ( var j = 0, l = bodies.length; j < l; j++ ){
          ...
          for ( var i = j + 1; i < l; i++ ){
            ...
            if ( bodyA.bodyName
              && ignoreBetween.includes(bodyA.bodyName)
              && bodyA.bodyName === bodyB.bodyName ) {
              continue;
            }
    ...
    return {
      ...
      collideBodies: function(bodyA, bodyB, normal, point, mtrans, contact){
        ...
        var fixedA = bodyA.treatment === 'static' || bodyA.treatment === 'kinematic'
          ...
          ,ingoreBetween = this.options.ingoreBetween || []
          ,scratch = Physics.scratchpad()
        ...
        // ignore pairs of specific bodies
        if (bodyA.bodyName
          && ingoreBetween.includes(bodyA.bodyName)
          && bodyA.bodyName === bodyB.bodyName) {
          return;
        }
    ...
    return {
      ...
      checkAll: function( data ){
        ...
        for ( var i = 0, l = bodies.length; i < l; i++ ){
          ...
          // only detect specific bodies
          if ( body.treatment === 'dynamic' && !(body.bodyName && ignore.includes( body.bodyName )) ){
    ...
    return {
      ...
      integrateVelocities: function( bodies, dt ){
        ...
        for ( var i = 0, l = bodies.length; i < l; ++i ){
          ...
          // only integrate if the body isn't static
          if ( body.treatment !== 'static' && !(body.bodyName && body.bodyName === 'feed') ){
